...
HD_PWD='/home/dimitris/di_vhdl/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSD_Lab2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSD_Lab2.tcl
