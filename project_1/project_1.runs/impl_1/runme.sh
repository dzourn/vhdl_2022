...
HD_PWD='/home/dimitris/di_vhdl/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSD_Lab2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSD_Lab2.tcl -notrace
