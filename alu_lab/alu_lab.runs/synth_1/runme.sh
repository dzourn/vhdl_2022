...
HD_PWD='/home/dimitris/di_vhdl/alu_lab/alu_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_lab.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_lab.tcl
